//1. (20%) Use the fetch API or Axios to communicate with an external web API. Use the data provided by this API to populate your application’s content and features.
...
async function getFighters() {
    ...
    const fighterName = fighterData.items
    console.log(fighterName);

    fighterName.forEach(fighter => {
